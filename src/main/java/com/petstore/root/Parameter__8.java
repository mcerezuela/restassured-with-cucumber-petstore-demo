...
public class Parameter__8 {
    ...
    @JsonProperty("schema")
    public Schema__41 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__41 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__8) == false) {
            return false;
        }
        Parameter__8 rhs = ((Parameter__8) other);
