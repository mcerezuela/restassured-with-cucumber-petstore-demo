...
public class Security__3 {
    ...
    public String toString() {
        ...
        sb.append(Security__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Security__3) == false) {
            return false;
        }
        Security__3 rhs = ((Security__3) other);
