...
public class Get__2 {
    ...
    private List<Parameter__2> parameters = new ArrayList<Parameter__2>();
    @JsonProperty("responses")
    private Responses__4 responses;
    @JsonProperty("security")
    private List<Security__4> security = new ArrayList<Security__4>();
    ...
    @JsonProperty("parameters")
    public List<Parameter__2> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__2> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__4 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__4 responses) {
        this.responses = responses;
    }

    @JsonProperty("security")
    public List<Security__4> getSecurity() {
        return security;
    }

    @JsonProperty("security")
    public void setSecurity(List<Security__4> security) {
    ...
    public String toString() {
        ...
        sb.append(Get__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Get__2) == false) {
            return false;
        }
        Get__2 rhs = ((Get__2) other);
