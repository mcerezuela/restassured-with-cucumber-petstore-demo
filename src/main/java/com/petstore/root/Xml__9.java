...
public class Xml__9 {
    ...
    public String toString() {
        ...
        sb.append(Xml__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("wrapped");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xml__9) == false) {
            return false;
        }
        Xml__9 rhs = ((Xml__9) other);
