...
public class Parameter__4 {
    ...
    @JsonProperty("schema")
    public Schema__20 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__20 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__4) == false) {
            return false;
        }
        Parameter__4 rhs = ((Parameter__4) other);
