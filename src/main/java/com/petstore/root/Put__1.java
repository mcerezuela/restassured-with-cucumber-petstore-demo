...
public class Put__1 {
    ...
    private List<Parameter__10> parameters = new ArrayList<Parameter__10>();
    @JsonProperty("requestBody")
    private RequestBody__6 requestBody;
    @JsonProperty("responses")
    private Responses__17 responses;
    ...
    @JsonProperty("parameters")
    public List<Parameter__10> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__10> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("requestBody")
    public RequestBody__6 getRequestBody() {
        return requestBody;
    }

    @JsonProperty("requestBody")
    public void setRequestBody(RequestBody__6 requestBody) {
        this.requestBody = requestBody;
    }

    @JsonProperty("responses")
    public Responses__17 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__17 responses) {
    ...
    public String toString() {
        ...
        sb.append(Put__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Put__1) == false) {
            return false;
        }
        Put__1 rhs = ((Put__1) other);
