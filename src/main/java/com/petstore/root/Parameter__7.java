...
public class Parameter__7 {
    ...
    @JsonProperty("schema")
    public Schema__32 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__32 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__7) == false) {
            return false;
        }
        Parameter__7 rhs = ((Parameter__7) other);
