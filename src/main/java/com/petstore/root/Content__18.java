...
public class Content__18 {

    @JsonProperty("application/xml")
    private ApplicationXml__13 applicationXml;
    @JsonProperty("application/json")
    private ApplicationJson__17 applicationJson;

    @JsonProperty("application/xml")
    public ApplicationXml__13 getApplicationXml() {
        return applicationXml;
    }

    @JsonProperty("application/xml")
    public void setApplicationXml(ApplicationXml__13 applicationXml) {
        this.applicationXml = applicationXml;
    }

    @JsonProperty("application/json")
    public ApplicationJson__17 getApplicationJson() {
        return applicationJson;
    }

    @JsonProperty("application/json")
    public void setApplicationJson(ApplicationJson__17 applicationJson) {
    ...
    public String toString() {
        ...
        sb.append(Content__18 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Content__18) == false) {
            return false;
        }
        Content__18 rhs = ((Content__18) other);
