...
public class Get__1 {
    ...
    private List<Parameter__1> parameters = new ArrayList<Parameter__1>();
    @JsonProperty("responses")
    private Responses__3 responses;
    @JsonProperty("security")
    private List<Security__3> security = new ArrayList<Security__3>();
    ...
    @JsonProperty("parameters")
    public List<Parameter__1> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__1> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__3 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__3 responses) {
        this.responses = responses;
    }

    @JsonProperty("security")
    public List<Security__3> getSecurity() {
        return security;
    }

    @JsonProperty("security")
    public void setSecurity(List<Security__3> security) {
    ...
    public String toString() {
        ...
        sb.append(Get__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Get__1) == false) {
            return false;
        }
        Get__1 rhs = ((Get__1) other);
