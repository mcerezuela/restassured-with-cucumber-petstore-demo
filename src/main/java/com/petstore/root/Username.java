...
public class Username {
    ...
    public String toString() {
        ...
        sb.append(Username.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Username) == false) {
            return false;
        }
        Username rhs = ((Username) other);
