...
public class Id__2 {
    ...
    public String toString() {
        ...
        sb.append(Id__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Id__2) == false) {
            return false;
        }
        Id__2 rhs = ((Id__2) other);
