...
public class Username__1 {
    ...
    public String toString() {
        ...
        sb.append(Username__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Username__1) == false) {
            return false;
        }
        Username__1 rhs = ((Username__1) other);
