...
public class Security__7 {
    ...
    public String toString() {
        ...
        sb.append(Security__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Security__7) == false) {
            return false;
        }
        Security__7 rhs = ((Security__7) other);
