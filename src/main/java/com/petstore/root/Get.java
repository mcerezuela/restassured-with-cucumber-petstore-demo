...
public class Get {
    ...
    private Responses__2 responses;
    @JsonProperty("security")
    private List<Security__2> security = new ArrayList<Security__2>();
    ...
    @JsonProperty("responses")
    public Responses__2 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__2 responses) {
        this.responses = responses;
    }

    @JsonProperty("security")
    public List<Security__2> getSecurity() {
        return security;
    }

    @JsonProperty("security")
    public void setSecurity(List<Security__2> security) {
