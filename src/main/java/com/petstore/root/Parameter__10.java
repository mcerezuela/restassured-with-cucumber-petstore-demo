...
public class Parameter__10 {
    ...
    @JsonProperty("schema")
    public Schema__49 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__49 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__10) == false) {
            return false;
        }
        Parameter__10 rhs = ((Parameter__10) other);
