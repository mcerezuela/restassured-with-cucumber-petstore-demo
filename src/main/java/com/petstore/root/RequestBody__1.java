...
public class RequestBody__1 {
    ...
    public String toString() {
        ...
        sb.append(RequestBody__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestBody__1) == false) {
            return false;
        }
        RequestBody__1 rhs = ((RequestBody__1) other);
