...
public class Get__5 {
    ...
    private List<Parameter__8> parameters = new ArrayList<Parameter__8>();
    @JsonProperty("responses")
    private Responses__14 responses;
    ...
    @JsonProperty("parameters")
    public List<Parameter__8> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__8> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__14 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__14 responses) {
    ...
    public String toString() {
        ...
        sb.append(Get__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Get__5) == false) {
            return false;
        }
        Get__5 rhs = ((Get__5) other);
