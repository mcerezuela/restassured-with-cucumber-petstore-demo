...
public class Post__4 {
    ...
    private RequestBody__4 requestBody;
    @JsonProperty("responses")
    private Responses__12 responses;
    ...
    @JsonProperty("requestBody")
    public RequestBody__4 getRequestBody() {
        return requestBody;
    }

    @JsonProperty("requestBody")
    public void setRequestBody(RequestBody__4 requestBody) {
        this.requestBody = requestBody;
    }

    @JsonProperty("responses")
    public Responses__12 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__12 responses) {
    ...
    public String toString() {
        ...
        sb.append(Post__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Post__4) == false) {
            return false;
        }
        Post__4 rhs = ((Post__4) other);
