...
public class Security__2 {
    ...
    public String toString() {
        ...
        sb.append(Security__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Security__2) == false) {
            return false;
        }
        Security__2 rhs = ((Security__2) other);
