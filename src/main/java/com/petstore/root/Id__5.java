...
public class Id__5 {
    ...
    public String toString() {
        ...
        sb.append(Id__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Id__5) == false) {
            return false;
        }
        Id__5 rhs = ((Id__5) other);
