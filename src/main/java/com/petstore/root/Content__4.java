...
public class Content__4 {

    @JsonProperty("application/xml")
    private ApplicationXml__4 applicationXml;
    @JsonProperty("application/json")
    private ApplicationJson__4 applicationJson;

    @JsonProperty("application/xml")
    public ApplicationXml__4 getApplicationXml() {
        return applicationXml;
    }

    @JsonProperty("application/xml")
    public void setApplicationXml(ApplicationXml__4 applicationXml) {
        this.applicationXml = applicationXml;
    }

    @JsonProperty("application/json")
    public ApplicationJson__4 getApplicationJson() {
        return applicationJson;
    }

    @JsonProperty("application/json")
    public void setApplicationJson(ApplicationJson__4 applicationJson) {
    ...
    public String toString() {
        ...
        sb.append(Content__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Content__4) == false) {
            return false;
        }
        Content__4 rhs = ((Content__4) other);
