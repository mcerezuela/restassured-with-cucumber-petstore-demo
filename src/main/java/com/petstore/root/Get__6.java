...
public class Get__6 {
    ...
    private Responses__15 responses;
    ...
    @JsonProperty("responses")
    public Responses__15 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__15 responses) {
    ...
    public String toString() {
        ...
        sb.append(Get__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Get__6) == false) {
            return false;
        }
        Get__6 rhs = ((Get__6) other);
