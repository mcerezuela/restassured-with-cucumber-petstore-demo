...
public class Parameter__3 {
    ...
    @JsonProperty("schema")
    public Schema__19 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__19 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__3) == false) {
            return false;
        }
        Parameter__3 rhs = ((Parameter__3) other);
