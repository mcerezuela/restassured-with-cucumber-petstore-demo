...
public class PetId {
    ...
    public String toString() {
        ...
        sb.append(PetId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PetId) == false) {
            return false;
        }
        PetId rhs = ((PetId) other);
