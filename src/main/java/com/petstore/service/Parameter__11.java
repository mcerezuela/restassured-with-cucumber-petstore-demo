...
public class Parameter__11 {
    ...
    @JsonProperty("schema")
    public Schema__53 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__53 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__11) == false) {
            return false;
        }
        Parameter__11 rhs = ((Parameter__11) other);
