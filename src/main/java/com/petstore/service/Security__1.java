...
public class Security__1 {
    ...
    public String toString() {
        ...
        sb.append(Security__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Security__1) == false) {
            return false;
        }
        Security__1 rhs = ((Security__1) other);
