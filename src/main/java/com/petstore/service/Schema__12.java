...
public class Schema__12 {
    ...
    public String toString() {
        ...
        sb.append(Schema__12 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Schema__12) == false) {
            return false;
        }
        Schema__12 rhs = ((Schema__12) other);
