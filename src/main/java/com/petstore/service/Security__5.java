...
public class Security__5 {
    ...
    public String toString() {
        ...
        sb.append(Security__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Security__5) == false) {
            return false;
        }
        Security__5 rhs = ((Security__5) other);
