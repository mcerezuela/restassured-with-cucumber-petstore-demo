...
public class Parameter__1 {
    ...
    @JsonProperty("schema")
    public Schema__13 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__13 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__1) == false) {
            return false;
        }
        Parameter__1 rhs = ((Parameter__1) other);
