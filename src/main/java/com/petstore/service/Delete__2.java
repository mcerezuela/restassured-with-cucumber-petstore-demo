...
public class Delete__2 {
    ...
    private List<Parameter__11> parameters = new ArrayList<Parameter__11>();
    @JsonProperty("responses")
    private Responses__18 responses;
    ...
    @JsonProperty("parameters")
    public List<Parameter__11> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__11> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__18 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__18 responses) {
    ...
    public String toString() {
        ...
        sb.append(Delete__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Delete__2) == false) {
            return false;
        }
        Delete__2 rhs = ((Delete__2) other);
