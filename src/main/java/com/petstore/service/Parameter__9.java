...
public class Parameter__9 {
    ...
    @JsonProperty("schema")
    public Schema__46 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__46 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__9) == false) {
            return false;
        }
        Parameter__9 rhs = ((Parameter__9) other);
