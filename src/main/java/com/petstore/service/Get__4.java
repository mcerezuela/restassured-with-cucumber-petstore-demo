...
public class Get__4 {
    ...
    private List<Parameter__6> parameters = new ArrayList<Parameter__6>();
    @JsonProperty("responses")
    private Responses__10 responses;
    ...
    @JsonProperty("parameters")
    public List<Parameter__6> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__6> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__10 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__10 responses) {
    ...
    public String toString() {
        ...
        sb.append(Get__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Get__4) == false) {
            return false;
        }
        Get__4 rhs = ((Get__4) other);
