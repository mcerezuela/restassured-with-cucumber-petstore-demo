...
public class Parameter__6 {
    ...
    @JsonProperty("schema")
    public Schema__29 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__29 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__6) == false) {
            return false;
        }
        Parameter__6 rhs = ((Parameter__6) other);
