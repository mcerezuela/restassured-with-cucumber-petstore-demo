...
public class Parameter__5 {
    ...
    @JsonProperty("schema")
    public Schema__21 getSchema() {
        return schema;
    }

    @JsonProperty("schema")
    public void setSchema(Schema__21 schema) {
        this.schema = schema;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameter__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Parameter__5) == false) {
            return false;
        }
        Parameter__5 rhs = ((Parameter__5) other);
