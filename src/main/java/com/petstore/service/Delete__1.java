...
public class Delete__1 {
    ...
    private List<Parameter__7> parameters = new ArrayList<Parameter__7>();
    @JsonProperty("responses")
    private Responses__11 responses;
    ...
    @JsonProperty("parameters")
    public List<Parameter__7> getParameters() {
        return parameters;
    }

    @JsonProperty("parameters")
    public void setParameters(List<Parameter__7> parameters) {
        this.parameters = parameters;
    }

    @JsonProperty("responses")
    public Responses__11 getResponses() {
        return responses;
    }

    @JsonProperty("responses")
    public void setResponses(Responses__11 responses) {
    ...
    public String toString() {
        ...
        sb.append(Delete__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tags");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Delete__1) == false) {
            return false;
        }
        Delete__1 rhs = ((Delete__1) other);
