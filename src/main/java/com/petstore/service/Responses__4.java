...
public class Responses__4 {

    @JsonProperty("200")
    private _200__4 _200;
    @JsonProperty("400")
    private _400__3 _400;
    @JsonProperty("404")
    private _404__1 _404;

    @JsonProperty("200")
    public _200__4 get200() {
        return _200;
    }

    @JsonProperty("200")
    public void set200(_200__4 _200) {
        this._200 = _200;
    }

    @JsonProperty("400")
    public _400__3 get400() {
        return _400;
    }

    @JsonProperty("400")
    public void set400(_400__3 _400) {
        this._400 = _400;
    }

    @JsonProperty("404")
    public _404__1 get404() {
        return _404;
    }

    @JsonProperty("404")
    public void set404(_404__1 _404) {
        this._404 = _404;
    }
    ...
    public String toString() {
        ...
        sb.append(Responses__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("_200");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Responses__4) == false) {
            return false;
        }
        Responses__4 rhs = ((Responses__4) other);
