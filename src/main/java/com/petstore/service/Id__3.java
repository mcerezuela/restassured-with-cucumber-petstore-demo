...
public class Id__3 {
    ...
    public String toString() {
        ...
        sb.append(Id__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Id__3) == false) {
            return false;
        }
        Id__3 rhs = ((Id__3) other);
