...
package com.petstore.components.schemas.pet;
...
public class PetResponseEntity {
    ...
    public String toString() {
        ...
        sb.append(PetResponseEntity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PetResponseEntity) == false) {
            return false;
        }
        PetResponseEntity rhs = ((PetResponseEntity) other);
